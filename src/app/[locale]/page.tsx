...
function Home() {
  return (
    <div className="pc:px-[28px]">
      <div className="max-w-[1200px] pc:mx-auto pc:my-[159px] mobile:w-full mobile:px-[16px] mobile:my-[32px]">
        {/* <Tabs /> */}
        <div className="flex pc:gap-[16px] mobile:flex-col mobile:gap-[30px]">
          ...
          <div className="pc:w-[38%] pc:max-w-[440px] pc:self-start mobile:w-full flex flex-col gap-[30px]">
            <PointsInfo />
            <HowToGet />
