...
export default function HowToEarn() {
    ...
    const showUploadModal = (preview: string, file: any, isSkip: number, formInfo: any) => {
    ...
    return (
        <div className="w-full">
            ...
            {/* 上传图片预览弹窗 */}
            <UploadModal ref={uploadModalRef} formInfo={formInfo} isSkip={isSkip} previewSrc={previewSrc} fileInfo={fileInfo} resetPreviewSrc={resetPreviewSrc} resetFileInfo={resetFileInfo} />
